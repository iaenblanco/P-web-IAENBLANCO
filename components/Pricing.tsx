      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="bg-white/5 backdrop-blur-lg p-8 rounded-2xl border border-white/10 h-full flex flex-col transition-all duration-300 hover:scale-105 hover:border-cyan-400">
            ...
            <p className="text-4xl font-bold mb-4">$127.500<span className="text-lg font-normal text-gray-400">/hr</span></p>
            <p className="text-gray-300 mb-6 h-16">Ideal para obtener dirección estratégica y resolver dudas puntuales.</p>
            <ul className="space-y-3 text-gray-300 mb-8">
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Sesión estratégica de 1 hora</li>
          ...
          <div className="bg-white/10 backdrop-blur-xl p-8 rounded-3xl border-2 border-cyan-400 shadow-[0_0_40px_rgba(0,255,255,0.4)] relative flex flex-col transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-4xl font-bold mb-4">Desde $1.700.000</p>
            <p className="text-gray-300 mb-6 h-16">Perfecto para integrar una solución de IA específica y medir su impacto.</p>
            <ul className="space-y-3 text-gray-300 mb-8">
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Todo en Consultoría, más:</li>
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Desarrollo de un Prototipo</li>
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Integración con tu sistema actual</li>
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Soporte prioritario</li>
            </ul>
          ...
          <div className="bg-white/5 backdrop-blur-lg p-8 rounded-2xl border border-white/10 h-full flex flex-col transition-all duration-300 hover:scale-105 hover:border-cyan-400">
            ...
            <ul className="space-y-3 text-gray-300 mb-8">
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Todo en Proyecto Piloto, más:</li>
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Soluciones de IA ilimitadas</li>
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Entrenamiento para tu equipo</li>
              <li className="flex items-center"><WandSparklesIcon className="h-5 w-5 text-cyan-400 mr-2 shrink-0"/>Soporte y mantenimiento dedicado</li>
            </ul>
